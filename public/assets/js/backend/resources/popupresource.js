define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'resources/popupresource/index',
                    add_url: 'resources/popupresource/add',
                    edit_url: 'resources/popupresource/edit',
                    del_url: 'resources/popupresource/del',
                    multi_url: 'resources/popupresource/multi',
                    table: 'popup_resource',
                }
            });
            ...
            table.on('post-body.bs.table', function (e, settings, json, xhr) {
                ...
                $('.btn-allot').off("click").on("click", function() {
                    ...
                    $.each(table.bootstrapTable('getSelections'), function (index, row) {
                        var url = 'resources/bindresource/popup_allot';
